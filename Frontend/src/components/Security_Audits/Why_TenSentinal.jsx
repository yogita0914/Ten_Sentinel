      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6 justify-items-center items-stretch">
          {features.map(({ label, icon }) => (
            <div
              key={label}
              className="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition duration-300 p-5 w-full h-full max-w-[180px] text-center flex flex-col items-center"
            >
