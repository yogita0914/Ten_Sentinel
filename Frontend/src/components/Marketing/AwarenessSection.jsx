      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-y-8 md:gap-x-20 px-4 py-6 bg-gray-100 mt-15">
        ...
        <div className="max-w-md px-2">
          <h3 className="text-xl sm:text-2xl font-bold mb-3">
            Need marketing awareness? Let us help you grow!
          </h3>
          <p className="text-gray-700 mb-3 text-sm sm:text-base">
            Our marketing training programs are tailored to specific audiences,
            ensuring relevance and practical application in real-world
            scenarios.
          </p>
          <p className="font-semibold text-sm sm:text-base">
            We provide marketing training for:
          </p>
        ...
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-4xl font-extrabold text-cyan-700 mb-4 leading-tight">
              The Awareness is provided on
              <br className="hidden md:block" />
              various basics and important topics{" "}
              <span className="text-cyan-600">including:</span>
            </h2>
            <p className="text-lg text-gray-600">
              Our sessions are designed to ensure practical understanding and
              safety for every digital user.
            </p>
          </div>
