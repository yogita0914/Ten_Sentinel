        ...
        <div className="max-w-7xl mx-auto lg:py-15 py-10 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            ...
            <div className="lg:w-1/2 text-gray-700 space-y-5 text-base leading-relaxed">
              <p>
                Designed specifically for working professionals, our
                Cybersecurity course combines flexibility with industry-relevant
                skills to fit seamlessly into your schedule.
              </p>
              <p>
                You'll get hands-on training through real-world simulations,
                build practical skills, and connect with peers and industry
                experts through structured internship opportunities.
              </p>
              <p>
                Personalized 1:1 mentorship from experienced cybersecurity
                professionals ensures you gain the guidance and support needed
                to elevate your career with confidence.
              </p>
              <p className="text-700 font-semibold">
                Ready to future-proof your career?{" "}
                <span>
                  Join our Online Cybersecurity Program today and take the next
                  step toward becoming a certified expert.
                </span>
              </p>
            </div>
