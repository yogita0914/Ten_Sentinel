...
//                 >
//                   Learn more
//                   <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2 group-hover:translate-x-1 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    <section className="relative py-24 overflow-hidden bg-green-50">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-100px" }}
        >
          {cloudServices.map((service) => ( // Removed index as key, using service.slu00g or service.name
            <motion.div
