        ...
        <div className={`flex flex-col items-center lg:flex-row lg:gap-10`}>
          ...
          {!isTabletView && (
            <div className="lg:w-1/2 text-left lg:pl-10">
              ...
              >
                GCP cloud security focuses on protecting sensitive data, ensuring compliance, and maintaining business continuity. As cyber threats continue to rise, strong security measures in GCP are essential to safeguard cloud infrastructure, applications, and workloads against potential risks.
              </motion.p>
            </div>
          )}
        </div>
