...
//       >
//         <span className="font-medium flex-1 mr-2">{question}</span> {/* Added flex-1 and mr-2 for better spacing with icon */}
//         {isOpen ? (
  ...
  return (
    <section className="bg-white py-12 px-6 lg:py-20 sm:px-12 lg:px-24">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-x-8">
          <div className="space-y-4">
            {firstHalf.map((item) => ( // Using item.id as the unique identifier
              <AccordionItem
                key={item.id}
                question={item.q}
                answer={item.a}
          ...
          <div className="space-y-4">
            {secondHalf.map((item) => ( // Using item.id as the unique identifier
              <AccordionItem
                key={item.id}
                question={item.q}
                answer={item.a}
