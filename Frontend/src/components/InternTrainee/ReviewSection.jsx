  ...
  const studentReview = [
    {
      ...
      name: "Ritika Sharma",
      date: "25 March 2024",
      studentImg: "https://static.vecteezy.com/system/resources/previews/030/798/365/non_2x/beautiful-asian-girl-wearing-over-size-hoodie-in-casual-style-ai-generative-photo.jpg",
    },
    {
      id: 2,
      ...
      name: "Aman Verma",
      date: "15 Feb 2024",
      studentImg: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNs1Nu8YGp0GjI9eYeA-L8A_jW7Z8Napam1GyRIuRPTXHt-pfKCvTDgDTDvGi7qJmT2ZE&usqp=CAU",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      name: "Rohit Mehta",
      date: "17 June 2024",
      studentImg: "https://c1.wallpaperflare.com/preview/369/675/600/boy-life-style-fashion-smile.jpg",
    },
    {
      id: 5,
      ...
      name: "Neha Gupta",
      date: "15 Feb 2025",
      studentImg: "https://www.shutterstock.com/shutterstock/photos/2151833739/display_1500/stock-photo-portrait-of-a-young-latin-woman-with-pleasant-smile-and-crossed-arms-isolated-on-grey-wall-with-2151833739.jpg",
    },
  ];
          ...
          <Slider {...settings}>
            {studentReview.map((review) => {
              ...
              const textToShow = isExpanded
                ...
                ? review.desc.slice(0, 150) + "..."
                : review.desc;

              return (
                <div key={review.id} className="px-3">
                <div className="bg-white w-full sm:w-[90%] md:w-[98%] lg:w-[410px] min-h-[180px] mx-auto rounded-lg shadow-md p-4 flex flex-col justify-between transition-all duration-300">
                    <div>
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <img
                          src="https://banner2.cleanpng.com/20240216/gwb/transparent-google-logo-google-logo-with-colorful-letter-g-1710875662233.webp"
                          alt="Google"
                          className="w-6 h-6"
                        />
                      </div>
                      <p className="text-gray-700 text-sm mb-2">{textToShow}</p>
                      {review.desc.length > 150 && (
                        <button
