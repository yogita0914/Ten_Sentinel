...
export const GCP = () => {
    ...
    const process = [
        ...
        {
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M480-80q-33 0-56.5-23.5T400-160h160q0 33-23.5 56.5T480-80ZM320-200v-80h320v80H320Zm10-120q-69-41-109.5-110T180-580q0-125 87.5-212.5T480-880q125 0 212.5 87.5T780-580q0 81-40.5 150T630-320H330Zm24-80h252q45-32 69.5-79T700-580q0-92-64-156t-156-64q-92 0-156 64t-64 156q0 54 24.5 101t69.5 79Zm126 0Z" /></svg>
            ),
        ...
        {
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M280-280h80v-200h-80v200Zm320 0h80v-400h-80v400Zm-160 0h80v-120h-80v120Zm0-200h80v-80h-80v80ZM200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H200Zm0-80h560v-560H200v560Zm0-560v560-560Z" /></svg>
            ),
    ...
    return (
        <>
            ...
            <header
                ...
                style={{ backgroundImage: `url(https://img.freepik.com/free-photo/biometric-technology-background-with-fingerprint-scanning-system-virtual-screen-digital-remix_53876-104197.jpg?ga=GA1.1.462800661.1745940262&semt=ais_hybrid&w=740)` }}
            >
                {/* Gradient Overlay */}
                <motion.div
                    initial={{ opacity: 0 }}
            ...
            <section className='flex flex-col px-4 py-6 gap-4 bg-gray-100 md:px-8 md:py-12 lg:px-12 lg:gap-8'>
                ...
                <SectionTitle>Why Choose Our GCP Penetration Testing?</SectionTitle>

                <ul className='grid gap-6 grid-cols-1 auto-rows-fr lg:grid-cols-3'>
                    {
                        whyChoose.map((item) => (
                            <li className='flex flex-col shadow-md bg-white rounded-md p-4 gap-2 lg:px-8'>
                                <div className='flex flex-row items-center gap-2'>
                                    {React.cloneElement(item.icon, {
                                        className: "lg:w-20 lg:h-20",
                                    })}
                                    <h3 className='text-base font-semibold md:text-lg lg:text-xl'>{item.title}</h3>
                                </div>
                                <p className='text-sm text-gray-600 md:text-base lg:text-lg'>{item.text}</p>
                            </li>
                        ))
                    }
            ...
            <section className='flex flex-col px-4 py-6 gap-4 bg-blue-800 md:px-8 md:py-12 lg:px-12'>
                ...
                <h2 className='text-lg font-semibold text-white md:text-2xl lg:self-center lg:text-3xl'>Some of the Tools that we use to Conduct GCP Penetration Testing!</h2>
                        ...
                        >
                            {tools.map((tool, index) => (
                                <SwiperSlide key={index} style={{ width: 'auto' }}>
                                    <div className='flex flex-col items-center justify-center bg-violet-200 gap-2 p-6 rounded-lg h-full mx-2'>
                                        <img className='w-20 h-20 object-contain' src={tool.icon} alt={tool.title} />
                                        <h3 className='text-base font-semibold text-center lg:text-lg'>{tool.title}</h3>
                                    </div>
                                </SwiperSlide>
                            ))}
                        </Swiper>
            ...
            <section className='flex flex-col px-4 py-6 gap-4 bg-gray-100 md:px-8 md:py-12 lg:px-12'>
                <SectionTitle>GCP Penetration Testing - What We Provide?</SectionTitle>

                <ul className='flex flex-col gap-8 md:grid md:grid-cols-2 md:auto-rows-fr lg:grid-cols-4'>
                    {provide.map((item) => (
                        <li className='flex flex-col gap-2 bg-white rounded-md shadow-md px-6 py-4 items-center justify-center'>
            ...
            <section className="flex flex-col items-center px-4 py-8 gap-8 md:pt-12 md:pb-24 md:gap-24 lg:px-12 xl:flex-row lg:justify-center lg:py-32">
                ...
                <div className="relative w-1/2 h-[500px] md:flex items-center justify-center hidden ">
                    ...
                    <div className="absolute z-10 w-72 h-72 p-4 rounded-full bg-blue-50 border-4 border-blue-200 flex flex-col gap-2 items-center justify-center">
                        <h4 className='text-sm text-blue-600 font-bold'>{process[activeProcess].title}</h4>
                        <span className="text-blue-800 text-center text-xs">{process[activeProcess].text}</span>
                    </div>
                    ...
                    <div className="relative w-full h-full">
                        {process.map((step, index) => {
                            ...
                            return (
                                <div className={`rounded-full border-4 ${step.color} w-32 h-32 flex flex-col justify-center items-center mb-2 transform -translate-x-1/2 -translate-y-1/2 absolute p-2
                                hover:bg-blue-100 ${index == activeProcess ? 'bg-blue-100' : 'bg-white'}`}
                                    style={{
                                        left: `calc(50% + ${x}px)`,
                                        top: `calc(50% + ${y}px)`
                                    }}
                                ...
                                >
                                    {React.cloneElement(step.icon, { className: "min-w-8 min-h-8" })}
                ...
                <ul className='flex flex-col gap-6 items-center justify-center max-w-[500px] md:hidden'>
                    {
                        process.map((step) => (
                            <li className='bg-gray-50 shadow-md rounded-sm flex flex-col gap-2 justify-center items-center py-4 px-2'>
                                <div className={`rounded-full border-4 ${step.color} w-20 h-20 flex justify-center items-center`}>
            ...
            <section className='flex flex-col px-4 py-6 gap-4 lg:px-12 lg:flex-row lg:justify-center lg:gap-16'>
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <form className='bg-gray-50 shadow-md rounded-md border border-gray-300 flex flex-col justify-center p-4 gap-4'>
            ...
            <section className="flex flex-col gap-4 items-center px-4 py-6 lg:px-12">
                ...
                <ul className="flex flex-col gap-8 w-full">
                    {faqs.map((faq, key) => (
                        <li
                            key={key}
                            className="flex flex-col bg-gray-100 rounded-lg shadow-xl lg:w-[800px] lg:self-center min-h-[80px] justify-center" // altura mínima
                        >
                            ...
                            <div className={`overflow-hidden transition-all duration-300 ${faq.isOpen ? "max-h-[1000px]" : "max-h-0"}`}>
                                <p className="text-sm text-gray-800 bg-gray-50 md:text-lg w-full px-4 py-2 md:px-8 md:py-6">
                                    {faq.response}
                                </p>
                            </div>
                        </li>
