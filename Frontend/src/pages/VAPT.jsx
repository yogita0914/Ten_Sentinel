  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <header
            ...
            >
              ...
              <div className="relative z-10 max-w-5xl mx-auto w-full">
                ...
                >
                  Identity, Analyze and Secure-Stay ahead of cyber threats
                </motion.p>
                <motion.div
                  initial={{ opacity: 0, y: 30 }}
                  animate={{ opacity: 1, y: 0 }}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div>
            <img src="https://img.freepik.com/free-vector/branding-identity-corporate-vector-logo-v-design_460848-9106.jpg?ga=GA1.1.1858429720.1745583539&semt=ais_hybrid&w=740"/>
        </motion.div>
          <motion.div 
